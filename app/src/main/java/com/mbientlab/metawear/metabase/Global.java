...
/**
 *  the class declared global constant variables
 */
class Global {
    /**
     * The Firebase param model.
     */
    static final String FIREBASE_PARAM_MODEL = "model",
    /**
     * The Firebase param device name.
     */
    FIREBASE_PARAM_DEVICE_NAME = "device_name",
    /**
     * The Firebase param firmware.
     */
    FIREBASE_PARAM_FIRMWARE = "firmware",
    /**
     * The Firebase param mac.
     */
    FIREBASE_PARAM_MAC = "mac",
    /**
     * The Firebase param log duration.
     */
    ...
    /**
     * The Name maximum char.
     */
    static final int nameMaxChar = 26, /**
     * The Metabase scan id.
     */
    METABASE_SCAN_ID = 0x2, /**
     * The Company id.
     */
    COMPANY_ID = 0x067e, /**
     * The Old company id.
     */
    OLD_COMPANY_Id = 0x626d;

    /**
     * Gets real model of the MetaBase device
     *
     * @param original    the original model name
