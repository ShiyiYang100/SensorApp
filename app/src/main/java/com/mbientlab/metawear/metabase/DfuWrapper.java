...
class DfuWrapper {
    /**
     * The type DfuException
     */
    static class DfuException extends RuntimeException {
        /**
         * Instantiates a new DfuException object
         *
         * @param message the message, which is shown when the DfuException occurs
         */
    ...
    public static class DfuProgressFragment extends DialogFragment {
        ...
        /**
         * New instance DfuProgress fragment.
         *
         * @param messageStringId the message string id
         * @return the DfuProgress fragment
         */
        ...
        /**
         * Update progress, update the progress bar
         *
         * @param newProgress the percent of the progress
         */
    ...
    /**
     * Instantiates a new DfuWrapper object
     *
     * @param activity the activity
     * @param manager  the manager, a FragmentManager object
     */
     ...
     * Start task.
     *
     * @param metawear   the MetaWear board
